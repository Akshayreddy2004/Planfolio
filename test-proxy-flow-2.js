...
async function testFetchExtensionless() {
    try {
        console.log("1. Simulating an upload WITHOUT format: 'pdf'...");
        const result = await cloudinary.uploader.upload(
            ...
            { resource_type: 'raw', folder: 'arch-plan-manager' } // removed format: 'pdf'
        );
